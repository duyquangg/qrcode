 ...
 */
const Icon = createIconSet(glyphMap, 'FontAwesome5Pro-Light', 'FontAwesome5Pro-Light.otf');

class FontAwesomeLight extends React.Component {
  constructor(props) {
    super(props);
  };
...
FontAwesomeLight.Icon = Icon;

export default FontAwesomeLight;
